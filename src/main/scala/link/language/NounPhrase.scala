...
object NounPhrase {
  ...
  final case class Thing[W](determiner: W, plural: Boolean, thing: W, predicates: List[Predicate[NounPhrase[W], W] with NounPredicate[NounPhrase[W], W]]) extends NounPhrase[W] 
